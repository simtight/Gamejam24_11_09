...
public class PlayerGrabStage2 : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (canGrab && hitCollider != null)
        {
            ...
            {
                boxCollider.offset = new Vector2(grabPoint.offset.x + 0.15f, grabPoint.offset.y);
        ...
        else
        {
            ...
            {
                Debug.Log("Right");
                grabPoint.offset = new Vector2(0.43f, -0.1f);
