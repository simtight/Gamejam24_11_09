...
public class PlayerGrabThree : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        boxCollider.size = new Vector2(0.02f, 0.02f);
        ...
        if (canGrab && hitCollider != null)
        {
            ...
            hitCollider.GetComponent<BoxCollider2D>().size = new Vector2(0.02f, 0.02f);

            if (grabPoint.offset.x > 0)
            {
                boxCollider.offset = new Vector2(grabPoint.offset.x + 0.02f, grabPoint.offset.y);
                boxCollider.size = new Vector2(0.01f, 0.05f);
                if (isRight)
                {
            ...
            {
                boxCollider.offset = new Vector2(grabPoint.offset.x, grabPoint.offset.y + 0.02f);
                boxCollider.size = new Vector2(0.05f, 0.01f);
                if (isUp)
                {
        ...
        else
        {
            ...
            {
                Debug.Log("Right");
                grabPoint.offset = new Vector2(0.05f, -0.01f);
            ...
            {
                grabPoint.offset = new Vector2(0f, 0.055f);
                anim.SetFloat("X", grabPoint.offset.x);
                anim.SetFloat("Y", grabPoint.offset.y);
                rb.velocity = new Vector3(0, speed, 0);
            }
            ...
            {
                grabPoint.offset = new Vector2(0.0f, -0.065f);
                anim.SetFloat("X", grabPoint.offset.x);
                anim.SetFloat("Y", grabPoint.offset.y);
                rb.velocity = new Vector3(0, -speed, 0);
            }
